...
const Hotel: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col pt-16 relative">
      {/* Enhanced nebula background with visible animations */}
      <div className="fixed inset-0 -z-10 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 overflow-hidden">
