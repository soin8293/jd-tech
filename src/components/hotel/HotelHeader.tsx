  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        <div className="max-w-5xl animate-slide-up opacity-0 space-y-6 bg-black/20 backdrop-blur-sm rounded-t-3xl rounded-b-2xl p-8 border border-white/10 relative" style={{ animationDelay: "0.3s", animationFillMode: "forwards" }}>
          <GradientHero className="absolute inset-0 rounded-t-3xl rounded-b-2xl" />
